...
> * (C++20~) [is_constant_evaluated()](??)가 추가되어 [constexpr 함수](https://tango1202.github.io/mordern-cpp/mordern-cpp-constexpr/#constexpr-%ED%95%A8%EC%88%98)가 컴파일 타임 함수인지 런타임 함수인지 검사할 수 있습니다.
...
C++20 부터는 [is_constant_evaluated()](??)가 추가되어 [constexpr 함수](https://tango1202.github.io/mordern-cpp/mordern-cpp-constexpr/#constexpr-%ED%95%A8%EC%88%98)가 컴파일 타임 함수인지 런타임 함수인지 검사할 수 있습니다.
