...
3. 함수 주석
   ...
   함수 선언 또는 정의의 선두에 위치하며, 함수의 목적, 설계 철학, 인자 정보, 리턴 정보, 예외 정보와 사용방법, 가정등이 기재됩니다. 또는 문서화 유틸리티를 위한 메타 주석이 포함될 수 있고, 함수가 전역 변수에 미치는 영향, 알고리즘의 출처등을 적을 수도 있겠죠. 특이 인자 정보를 적을때에는 명칭, 의미, 허용범위, 단위등도 포함되어야 합니다.
