...
|[weak_ptr](https://tango1202.github.io/mordern-cpp-stl/mordern-cpp-stl-share_ptr-weak_ptr/#weak_ptr)|`weak_ptr`은 `shared_ptr`의 상호 참조 문제를 해결합니다.|
|[pointer_traits](https://tango1202.github.io/mordern-cpp-stl/mordern-cpp-std-memory/#pointer_traits)|포인터와 유사한 타입들을 다루는 표준화된 방법을 제공합니다.|
...
|[tuple](https://tango1202.github.io/mordern-cpp-stl/mordern-cpp-stl-tuple/)|`tuple`은 다수의 요소를 관리할 수 있는 데이터 전달용 개체를 손쉽게 만듭니다.|
