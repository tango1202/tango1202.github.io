...
> * [shift_left(), shift_right()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-algorithm/#%EC%88%98%EC%A0%95%EB%90%98%EB%8A%94-%EC%8B%9C%ED%80%80%EC%8A%A4-%EC%9E%91%EC%97%85)가 추가되었습니다.
> * [lexicographical_compare_three_way()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-algorithm/#%EB%B9%84%EA%B5%90-%EC%9E%91%EC%97%85)가 추가되었습니다.
...
|[remove()](https://tango1202.github.io/legacy-cpp-stl/legacy-cpp-stl-algorithm/#remove)<br/>`remove_if()`<br/>`remove_copy()`<br/>`remove_copy_if()`|`value`가 아닌 요소는 시퀀스의 앞으로 옮기고 삭제할 위치를 리턴합니다.(*[컨테이너](https://tango1202.github.io/cpp-stl/modern-cpp-stl-container/) 버전이 효율적입니다.*)|(C++20~)|
...
[midpoint()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-algorithm/#%EC%88%98%ED%95%99-%EC%9E%91%EC%97%85)는 중간점인 `a + (b - a) / 2`를 구합니다. 정수인 경우 나누어 떨어지지 않으면 내림합니다.
