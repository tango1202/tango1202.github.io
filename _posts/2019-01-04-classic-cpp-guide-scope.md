...
특히 이름 충돌시 매크로가 관여되면 대환장 파티가 열릴 수 있습니다.([전처리기(매크로 상수, 매크로 함수, 조건부 포함, include, Pragma) 참고](https://tango1202.github.io/classic-cpp-guide/classic-cpp-guide-preprocessor/) 참고)
