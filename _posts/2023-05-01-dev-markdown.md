...
순서있는 목록은 숫자뒤에 `.` 을 사용하고, 순서없는 목록은 `*`, `+`, `-`를 사용합니다. 순서없는 목록에서 하위 항목을 만드려면 앞에 Tab을 추가해야 합니다.
...
**(오류)** A의 하위항목인데 들여쓰기를 하지 않았습니다.(튀어 나와 보이고, Markdown 변환기에 따라 하기 2번째 목록이 1로 초기화 될 수도 있습니다.)
