...
> * (C++11~) 비정적 멤버 변수도 멤버 선언부에서 초기화를 할 수 있어 초기화 작성이 쉬워졌습니다.
...
하지만, C++14 이전 버전은 멤버 선언부 초기화와 함께 사용하면 컴파일 오류가 발생했는데요, C++14 부터는 이를 완화하여 비정적 멤버 변수를 초기화하더라도 중괄호 집합 초기화를 사용할 수 있습니다.
