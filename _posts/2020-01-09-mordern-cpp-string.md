...
sidebar: 
    nav: "docs"
---
> * `char8_t`, `char16_t`, `char32_t`, `u8string`, `u16string`, `u32string` 이 추가되어 유니코드를 지원합니다.
> * `u8""`, `u""`, `U""` 리터럴이 추가되어 유니코드를 지원합니다. 
> * `R"()"`리터럴이 초가되어 개행된 문자열이나 확장된 기호 표시를 좀더 편하게 입력할 수 있습니다.
