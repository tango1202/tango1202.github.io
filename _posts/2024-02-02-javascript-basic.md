...
따라서 함수 정의 전에 사용하더라도 사용할 수 있습니다.

```javascript
console.log("함수 호이스팅", myHoistingFunc(1, 2)); // 3. 함수 정의 전에 사용할 수 있습니다.

function myHoistingFunc(a, b) {
    return a + b;
}
```
...
함수 정의를 외부에서 문자열로 전달받아 함수로 생성할 수 있습니다.
...
동일한 구조의 개체를 여러개 생성하고자 할때 매번 리터럴 방식으로 생성하면, 속성값 정의나 메서드 정의가 중복 될 수 있습니다. 이러한 경우에는 생성자 함수를 통해 개체를 생성하는게 좋습니다.
...
var user = {
    name: 'Lee',
    'addr': 'Seoul', // 속성명을 문자열로 정의할 수 있습니다.
    1 : '1',
    2 : '2',
    'my number': '123-4567' // 속성명에 공백 문자등 일반적으로 사용할 수 없는 문자가 있으면 문자열로만 정의할 수 있습니다.
};
