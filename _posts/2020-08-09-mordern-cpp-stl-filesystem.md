...
> * (C++17~) [예외](https://tango1202.github.io/mordern-cpp-stl/mordern-cpp-stl-filesystem/#%EC%98%88%EC%99%B8)가 추가되어 파일 시스템 오류 발생시 `filesystem_error` [예외를 발생](??)합니다.
...
|항목|내용|
|--|--|
|`filesystem_error` (C++17~)|파일 시스템 처리에서 오류가 [발생](??)했습니다.|
