...
보통 편집 프로그램에서 사용되는 개체는 글꼴, 테두리, 채우기 속성을 가지고 있습니다. 대부분 Look & Feel을 일관되게 유지하고자 동일한 글꼴, 테두리, 채우기 속성을 사용합니다. 모든 개체의 글꼴, 테두리, 채우기 속성을 다르게 하는 문서는 거의 없죠. 즉, 여러 개체에서 동일한 속성을 빈번하게 사용합니다. 
...
따라서, 중복되는 것은 서로 공유하여 메모리를 알뜰하게 사용하는게 좋습니다.
