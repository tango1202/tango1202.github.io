...
|[다차원](https://tango1202.github.io/classic-cpp-guide/classic-cpp-guide-pointer-reference/#%EB%8B%A4%EC%B0%A8%EC%9B%90-%ED%8F%AC%EC%9D%B8%ED%84%B0)|`int*`의 포인터인 `int**`가 지원됩니다.<br/>`int* p;`<br/>`int** pp = &p;`|참조자의 참조는 불법입니다.<br/>`int& r = val;`<br/>`int& & rr = r; // (X)`|
