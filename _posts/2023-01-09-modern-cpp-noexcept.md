...
> * [MEC++#14] 예외를 방출하지 않을 함수는 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)로 선언하라.(*[느슨한 noexcept 계약](https://tango1202.github.io/cpp/modern-cpp-noexcept/#%EB%8A%90%EC%8A%A8%ED%95%9C-noexcept-%EA%B3%84%EC%95%BD) 참고*)
>   * [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)는 최적화 여지가 크다. [이동 생성자](https://tango1202.github.io/cpp/modern-cpp-rvalue-value-category-move/#%EC%9D%B4%EB%8F%99-%EC%83%9D%EC%84%B1%EC%9E%90), [이동 대입 연산자](https://tango1202.github.io/cpp/modern-cpp-rvalue-value-category-move/#%EC%9D%B4%EB%8F%99-%EB%8C%80%EC%9E%85-%EC%97%B0%EC%82%B0%EC%9E%90), `swap()`, [소멸자](https://tango1202.github.io/legacy-cpp-oop/legacy-cpp-oop-destructors/)는 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)로 만들어라.
...
C++11 부터는 예외의 나열이 불필요함을 공감하여, [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)로 예외를 방출하냐 안하냐만 명시합니다.
...
|`noexcept(true)` (C++11~)|[noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)와 동일합니다.|
...
[상수성 계약](https://tango1202.github.io/legacy-cpp-guide/legacy-cpp-guide-const-mutable-volatile/#%EC%83%81%EC%88%98%EC%84%B1-%EA%B3%84%EC%95%BD)이 ***상수는 상수만 접근한다*** 이듯이, [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)는 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)만 접근한다는 계약이 있으면 컴파일 단계에서 감지되어 참 좋을텐데 말이죠. 왜 이런가 봤더니 기존 C스타일 함수는 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)를 지정할 수 없으니, 호출의 호환성을 유지하기 위해 이렇게 느슨하게 했다는군요.(*아쉽지만, 개발자에게 충분한 자유도를 주는 표준화 위원들의 의견도 존중합니다.*)

아무튼 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)는 컴파일 오류 감지가 안되기에 가볍게 넣거나 뺄 수 있는 코딩 계약이 아닙니다. [상수성 계약](https://tango1202.github.io/legacy-cpp-guide/legacy-cpp-guide-const-mutable-volatile/#%EC%83%81%EC%88%98%EC%84%B1-%EA%B3%84%EC%95%BD)처럼 컴파일 오류로 감지할 수 있으면, [const](https://tango1202.github.io/legacy-cpp-guide/legacy-cpp-guide-const-mutable-volatile/)를 무조건 들이댄 것처럼 쉽게 적용할 수 있지만, 마구잡이로 적용했다가 [예외 발생](https://tango1202.github.io/legacy-cpp-exception/legacy-cpp-exception-mechanism/#%EC%98%88%EC%99%B8-%EB%B0%9C%EC%83%9D%EA%B3%BC-%ED%83%90%EC%A7%80try-catch-throw) 상황이 되면, 이를 수습하느라 인생을 낭비하게 될 수 있습니다. 

내부적으로 사용하는 하위 함수와 그 함수가 향후에 어떻게 변화될 것인지 신중하게 고려하여 적용하시고, 하위 함수들도 꼭 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)로 작성하여 ***[noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/) 계약***을 만들어 두시는게 좋습니다.

따라서 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/) 함수를 만들때는 다음을 고려하세요.

1. 사용되는 하위 함수들도 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)인지 면밀히 검토하여야 합니다. 
...
하지만 그럼에도 불구하고 다음은 꼭 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)를 고려하십시요.

1. 복사 연산을 안전하게 [이동 연산](https://tango1202.github.io/cpp/modern-cpp-rvalue-value-category-move/#%EC%9D%B4%EB%8F%99-%EC%97%B0%EC%82%B0%EC%9D%B4%EB%8F%99-%EC%83%9D%EC%84%B1-%EC%9D%B4%EB%8F%99-%EB%8C%80%EC%9E%85--%EC%9A%B0%EC%B8%A1%EA%B0%92-%EC%B0%B8%EC%A1%B0-%EC%9D%B4%EB%8F%99-%EC%83%9D%EC%84%B1%EC%9E%90-%EC%9D%B4%EB%8F%99-%EB%8C%80%EC%9E%85-%EC%97%B0%EC%82%B0%EC%9E%90)으로 변환할 수 있는 [이동 생성자](https://tango1202.github.io/cpp/modern-cpp-rvalue-value-category-move/#%EC%9D%B4%EB%8F%99-%EC%83%9D%EC%84%B1%EC%9E%90), [이동 대입 연산자](https://tango1202.github.io/cpp/modern-cpp-rvalue-value-category-move/#%EC%9D%B4%EB%8F%99-%EB%8C%80%EC%9E%85-%EC%97%B0%EC%82%B0%EC%9E%90)
(*[암시적 이동 연산 변환](https://tango1202.github.io/cpp/modern-cpp-rvalue-value-category-move/#%EC%95%94%EC%8B%9C%EC%A0%81-%EC%9D%B4%EB%8F%99-%EC%97%B0%EC%82%B0-%EB%B3%80%ED%99%98) 참고*)
...
C++11 부터는 [소멸자](https://tango1202.github.io/legacy-cpp-oop/legacy-cpp-oop-destructors/)는 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)가 생략되었더라도 기본적으로 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)로 동작합니다.
...
컴파일 타임에 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/) 인지 검사합니다.
...
기존에는 함수 유형에 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)가 포함되지 않았습니다.

따라서, [함수 포인터](https://tango1202.github.io/legacy-cpp-guide/legacy-cpp-guide-function/#%ED%95%A8%EC%88%98-%ED%8F%AC%EC%9D%B8%ED%84%B0)로 유형 정의를 할때 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)를 포함할 수 없었습니다.
...
C++17 부터는 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)가 함수 유형에 포함되었으므로, 다음 예제처럼 [noexcept](https://tango1202.github.io/cpp/modern-cpp-noexcept/)인 함수만 전달받게 할 수 있습니다. 따라서 예외 처리에 대한 코딩 계약을 좀더 단단하게 할 수 있습니다.
