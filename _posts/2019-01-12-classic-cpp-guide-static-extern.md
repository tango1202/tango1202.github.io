...
|항목|내용|
|--|--|
|전역 변수|모든 파일에서 사용 가능한 변수. `extern` 선언|
|정적 전역 변수|현재 파일에서만 사용할 수 있는 전역 변수로서 제어가 처음으로 선언을 통과할때 생성됨|
...
함수내의 정적 지역 변수는 최초 1회만 초기화되는 특징을 가지고 있습니다. 전역 변수, 정적 전역 변수 대신 사용하면, 언제 생성되는지 좀더 명시적으로 알 수 있고, 전역 자원을 [캡슐화](https://tango1202.github.io/principle/principle-encapsulation/)하기도 좋습니다.
