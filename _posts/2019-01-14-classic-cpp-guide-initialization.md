...
또한, 개체 생성시 초기화를 하지 않으면, 초기화되지 않은 개체를 사용하는 실수를 할 수 있습니다. 그러니 항상 생성과 동시에 초기화 하는 것이 좋습니다.(Resource Acquisition Is Initialization(RAII). 자원 획득이 초기화, 즉 생성한 개체는 모두 유효해야 합니다.)
