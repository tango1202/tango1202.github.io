...
암시적으로 형변환 되지 않는다면, 하기와 같이 괄호를 이용하여 명시적으로 형변환 할 수 있습니다.(잘못 사용하면 예기지 못한 데이터 절삭이나 잘못된 변환으로 예외가 발생할 수 있으므로, 사용하지 말아야 합니다. 심지어 검색도 어렵습니다. C언어의 나쁜 잔재입니다.)
...
하지만, 기본 암시적 형변환과 잘 호환되도록 주의해야 합니다. 심지어 코드 분석도 힘들어 집니다. 하기와 같이 멤버함수를 작성해도 충분히 사용하기 좋고, 사용 위치를 검색하기 좋고, 분석하기 좋습니다.
