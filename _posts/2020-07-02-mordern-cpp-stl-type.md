...
|[bad_typeid](https://tango1202.github.io/mordern-cpp-stl/mordern-cpp-stl-diagnostics/#%ED%91%9C%EC%A4%80-%EC%98%88%EC%99%B8)|널포인터를 역참조하여 typeid를 구할때 [발생](??)합니다.<br/>`T* p = NULL;`<br/>`typeid(*p).name();`|
