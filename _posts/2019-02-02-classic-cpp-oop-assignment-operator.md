...
이릉 해결하기 위해, 암시적 대입 연산자를 사용하지 않고, 다음처럼 대입 연산자를 명시적으로 구현하여, 힙 개체의 복제본을 만들 수 있습니다.
...
복사 생성자의 경우와 마찬가지로, 대입 연산자를 케이스에 따라 일일이 명시적으로 개발하기 보다는, 암시적 대입 연산자를 그대로 사용할 수 있도록 핸들러를 만드는게 좋습니다.
