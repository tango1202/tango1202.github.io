...
> **모던 C++**
> * 함수 인자에 의존하여 리턴 타입을 결정하는 후행 리턴이 추가되었습니다.([후행 리턴](??)과 [리턴 타입 추론](https://tango1202.github.io/mordern-cpp/mordern-cpp-auto-decltype/#%EB%A6%AC%ED%84%B4-%ED%83%80%EC%9E%85-%EC%B6%94%EB%A1%A0) 참고) 
