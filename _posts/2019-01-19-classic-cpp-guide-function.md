...
|`[throw(exception-list)]`|함수가 발생하는 예외 사양.<br/>나열된 예외 이외에는 `unexpected`로 강제 변환됨. 사용하지 말 것.([예외 지정](https://tango1202.github.io/classic-cpp-exception/classic-cpp-exception-try-catch-throw/#%EC%98%88%EC%99%B8-%EC%A7%80%EC%A0%95) 참고)|
