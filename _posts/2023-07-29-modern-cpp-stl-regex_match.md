---
layout: single
title: "#29. [모던 C++ STL] regex_match, regex_search, regex_replace(C++11)"
categories: "cpp-stl"
tag: ["cpp"]
...
> * (C++11~) [regex_match()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_match)가 추가되어 문자열의 전체가 정규 표현식과 일치하는지 검사할 수 있습니다.
> * (C++11~) [regex_search()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_search)가 추가되어 문자열의 일부가 정규 표현식과 일치하는지 검사할 수 있습니다.
> * (C++11~) [regex_iterator](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_iterator)가 추가되었습니다. 문자열 전체에 대해 [regex_search()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_search) 한 결과의 [이터레이터](https://tango1202.github.io/cpp-stl/modern-cpp-stl-iterator/)입니다.
> * (C++11~) [regex_replace()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_replace)가 추가되어 문자열에서 정규 표현식과 일치하는 부분을 수정할 수 있습니다.
...
|항목|내용|
|--|--|
|`basic_regex` (C++11~)|정규 표현식을 저장합니다.([regex_match()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_match) 참고)<br/>* `regex` : `basic_regex<char>` 입니다.<br/>* `wregex` : `basic_regex<wchar_t>` 입니다.|
|`sub_match` (C++11~)|(작성중)|
|`match_results` (C++11~)|정규 표현식의 매칭 결과를 저장합니다.([regex_search()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_search) 참고)<br/>* `cmatch` : `match_result<const char*>` 입니다.<br/>* `wcmatch` : `match_result<const wchar_t*>` 입니다.<br/>* `smatch` : `match_result<string::const_iterator>` 입니다.<br/>* `wsmatch` : `match_result<wstring::const_iterator>` 입니다.|
|[regex_match()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_match) (C++11~)|문자열의 전체가 정규 표현식과 일치하는지 검사합니다.|
|[regex_search()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_search) (C++11~)|문자열의 일부가 정규 표현식과 일치하는지 검사합니다.|
|[regex_replace()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_replace) (C++11~)|문자열에서 정규 표현식과 일치하는 부분을 수정합니다.|
|[regex_iterator](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_iterator) (C++11~)|문자열 전체에 대해 [regex_search()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_search) 한 결과의 [이터레이터](https://tango1202.github.io/cpp-stl/modern-cpp-stl-iterator/)입니다.<br/>* `cregex_iterator` : `regex_iterator<const char*>` 입니다.<br/>* `wcregex_iterator` : `regex_iterator<const wchar_t*>` 입니다.<br/>* `sregex_iterator` : `regex_iterator<string::const_iterator>` 입니다.<br/>* `wsregex_iterator` : `regex_iterator<wstring::const_iterator>` 입니다.|
...
문자열 전체에 대해 [regex_search()](https://tango1202.github.io/cpp-stl/modern-cpp-stl-regex_match/#regex_search) 한 결과의 [이터레이터](https://tango1202.github.io/cpp-stl/modern-cpp-stl-iterator/)입니다. 상기 예제에서는 `while()`과 `suffix()` 를 사용했지만, [이터레이터](https://tango1202.github.io/cpp-stl/modern-cpp-stl-iterator/)를 이용하여 다음과 같이 간소화 할 수 있습니다.
