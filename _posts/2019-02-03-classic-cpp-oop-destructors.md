...
> * [public Non-Virtual 소멸자]()인 개체는 상속하지 마라.
...
다음은 부모 개체를 상속받아 자식 개체에서 타입명만 다르게 하여 사용한 한 예입니다. `Error`에서는 자식 개체에서 필요로하는 모든 함수를 제공하고 있어 별도의 가상 함수 정의가 필요없고, 다형 소멸을 위해 [public Virtual 소멸자](https://tango1202.github.io/classic-cpp-oop/classic-cpp-oop-destructors/#public-virtual-%EC%86%8C%EB%A9%B8%EC%9E%90)만 제공하고 있습니다.
