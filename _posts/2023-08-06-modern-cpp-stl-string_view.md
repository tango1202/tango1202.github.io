...
> * (C++20~) [u8string_view](https://tango1202.github.io/cpp-stl/modern-cpp-stl-string_view/#%EA%B0%9C%EC%9A%94)가 추가되었습니다.
...
C++17 부터는 [string_view](https://tango1202.github.io/cpp-stl/modern-cpp-stl-string_view)가 추가되어 문자열을 읽기 전용으로 사용할 때 불필요한 문자열 복제가 없도록 해줍니다.
...
[basic_string](https://tango1202.github.io/cpp-stl/modern-cpp-stl-string/#basic_string)처럼 기본 클래스는 `basic_string_view` 이며, 처리하는 문자 타입에 따라 재정의한 [string_view](https://tango1202.github.io/cpp-stl/modern-cpp-stl-string_view), `wstring_view`등을 사용합니다.

|항목|내용|
|--|--|
|[string_view](https://tango1202.github.io/cpp-stl/modern-cpp-stl-string_view) (C++17~)|`basic_string_view<char>`|
...
|항목|내용|
|--|--|
|`basic_string_view()` (C++17~)|빈 [string_view](https://tango1202.github.io/cpp-stl/modern-cpp-stl-string_view) 개체를 생성합니다.|
...
|`swap()` (C++17~)|두 [string_view](https://tango1202.github.io/cpp-stl/modern-cpp-stl-string_view)의 내부 데이터를 바꿔치기 합니다.|
...
|`begin(), end()` (C++17~)|순방향 [이터레이터](https://tango1202.github.io/cpp-stl/modern-cpp-stl-iterator/)를 리턴합니다.|
...
|`cbegin(), cend()` (C++17~)|순방향 [이터레이터](https://tango1202.github.io/cpp-stl/modern-cpp-stl-iterator/)를 리턴합니다. 이때 요소를 수정할 수 없습니다.|
...
|[data()](https://tango1202.github.io/legacy-cpp-stl/legacy-cpp-stl-string/#c%EC%8A%A4%ED%83%80%EC%9D%BC-%EB%AC%B8%EC%9E%90%EC%97%B4%EA%B3%BC%EC%9D%98-%ED%98%B8%ED%99%98data-c_str) (C++17~)|[컨테이너](https://tango1202.github.io/cpp-stl/modern-cpp-stl-container/)가 관리하는 메모리 블록을 리턴합니다. 끝에 [널문자(*정수 0인 문자, `'\0'`*)](https://tango1202.github.io/legacy-cpp-guide/legacy-cpp-guide-string/#%EB%84%90%EC%A2%85%EB%A3%8C-%EB%AC%B8%EC%9E%90%EC%97%B4)가 없을 수도 있습니다.|
