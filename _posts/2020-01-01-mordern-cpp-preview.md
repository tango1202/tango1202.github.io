...
|[개선된 제어문](https://tango1202.github.io/mordern-cpp/mordern-cpp-statement/) (C++11~)|[범위 기반 for()](https://tango1202.github.io/mordern-cpp/mordern-cpp-statement/#%EB%B2%94%EC%9C%84-%EA%B8%B0%EB%B0%98-for)가 추가되어 컨테이너 요소의 탐색 처리가 쉬워졌습니다.<br/><br/>**(C++17~)**<br/>[초기식을 포함하는 if(), switch()](??) 가 추가되어 함수 리턴값을 평가하고 소멸하는 코드가 단순해 졌습니다.|
