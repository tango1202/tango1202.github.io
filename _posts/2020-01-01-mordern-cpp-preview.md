...
|[decltype(auto)](https://tango1202.github.io/mordern-cpp/mordern-cpp-auto-decltype/#c14-decltypeauto) (C++14~)|`decltype()`의 `()`내 표현식이 복잡할 경우 `decltype(auto)` 와 같이 좀더 간결하게 작성할 수 있습니다.|
