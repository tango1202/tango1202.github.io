...
|[사용자 정의 리터럴](??) (C++11~)|`int operator ""_km(long double val);`와 같은 사용자 정의 리터럴이 추가되어 단위계 처리가 쉬워졌습니다.|
...
|[이진 리터럴](??) (C++14~)| `0b`, `0B` 접두어를 이용하여 이진수 상수를 표현할 수 있습니다.|
